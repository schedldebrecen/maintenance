...
// --- RAKTÁR ALKATRÉSZ LEZÁRÁSA UPDATE ---
    ...
    try {
        ...
        if(r.status === "success") {
            ...
            r.data.forEach(t => {
                ...
                // Biztonságos szöveg konverzió (idézőjelek, sortörések és számok védelme)
